...
for genre in list(unique_genres):
    ...
    temp_df = temp_df[temp_df.singer_ids != '0']
    temp_df = temp_df[temp_df.singer_ids != '[]']
    temp_df = temp_df[temp_df.songwriter_ids != '0']
    temp_df = temp_df[temp_df.songwriter_ids != '[]']
    ...
    temp_df = temp_df.groupby('singer_ids').mean()
